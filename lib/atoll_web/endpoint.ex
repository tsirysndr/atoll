defmodule AtollWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :atoll
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :atoll
  end
  ...
  plug AtollWeb.AccountBrowserPlug
  ...
  plug AtollWeb.RepoImportPlug
  plug AtollWeb.XRPCQueryPlug
