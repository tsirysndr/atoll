        ...
        {:ok, page} ->
          ...
          page(
            ...
            "<p>Revoking access disconnects this application. Other applications remain connected.</p>" <>
              ...
              csrf() <> "<button>Sign out</button></form>"
          )
